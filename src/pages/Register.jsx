      ...
      <form onSubmit={formik.handleSubmit} className="mx-auto" style={{ maxWidth: '600px' }}>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            name="username"
            type="text"
            className={`form-control bg-secondary text-white ${formik.touched.username && formik.errors.username ? 'is-invalid' : ''}`}
        ...
        <div className="mb-3">
          ...
          <input
            ...
            name="email"
            type="email"
            className={`form-control bg-secondary text-white ${formik.touched.email && formik.errors.email ? 'is-invalid' : ''}`}
        ...
        <div className="mb-3">
          ...
          <input
            ...
            name="password"
            type="password"
            className={`form-control bg-secondary text-white ${formik.touched.password && formik.errors.password ? 'is-invalid' : ''}`}
        ...
        <div className="text-center">
          <button type="submit" className="btn btn-light" disabled={!formik.isValid}>Create account</button>
        </div>
      </form>
    </div>
  );
